...
def reference_goal(constraints: dict, ace_backend: str) -> np.ndarray:
    ...
    vdd   = constraints.get('vsup', {}).get('init', 3.3)
    return { 'xh035-3V3': { "A":           8.5e-10      # 8.35135e-10
                          , "a_0":         65.0         # 65.50825257646494
                          , "ugbw":        600.0e3      # 608137.1389850643
                          , "sr_r":        450.0e3      # 482568.7087129002
                          , "sr_f":        450.0e3      # -478544.5088903557
                          , "pm":          90.0         # 89.13695404645551
                          , "gm":          -65.0        # -67.66169835915815
                          , "cmrr":        150.0        # 162.47373336546218
                          , "psrr_n":      100.0        # 100.13765587162408
                          , "psrr_p":      120.0        # 129.22912741937355
                          , "idd":         1.5e-5       # 1.5197106684950545e-05
                          , "iss":         -1.2e-5      # -1.8197106699045546e-05
                          ...
                          , "voff_stat":   7.5e-3       # 0.0072408778584526915
                          , "voff_sys":    -5.0e-7      # -4.817662030216676e-07
                          , }
           , 'xh018-1V8': { "A":           8.5e-10      # 8.35135e-10
                          , "a_0":         65.0         # 65.50825257646494
                          , "ugbw":        600.0e3      # 608137.1389850643
                          , "sr_r":        450.0e3      # 482568.7087129002
                          , "sr_f":        450.0e3      # -478544.5088903557
